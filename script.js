document.addEventListener('DOMContentLoaded', function() {
    ...
    const ajouterAuPanier = document.getElementById('ajouterAuPanier'); // Déclarée ici
    ...
    ajouterAuPanier.addEventListener('click', function() { // Utiliser la constante déjà déclarée
